...
import (
	...
	"github.com/eriquisanti/rocketseat-go-end-react-service/internal/store/pgstore"
...
func (h apiHandler) notifyClients(msg Message) {
	...
	for conn, cancel := range subscribers {
		if err := conn.WriteJSON(msg); err != nil {
			slog.Error("failed send message to client", "error", err)
			cancel()
		}
	}
}
...
func (h apiHandler) handleCreateRoom(w http.ResponseWriter, r *http.Request) {
	...
	roomID, err := h.q.InsetRoom(r.Context(), body.Theme)
	if err != nil {
